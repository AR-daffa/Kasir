...
//hitung jumlah buku fiksi
$h1 = mysqli_query($c,"select * from fiksi");
            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Buku Fiksi</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body">Jumlah Buku Fiksi: <?=$h2?></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from fiksi");
                                    $i = 1;
                            ...
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$penulis_bf;?></td>
                                            <td><?=$penerbit_bf;?></td>
                                            <td><?=$tahunterbit_bf;?></td>
                                            <td><?=$kotaterbit_bf;?></td>
                                            <td><button type="button" class="btn btn-warning mb-4" data-toggle="modal" data-target="#edit<?=$idf;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" data-toggle="modal" data-target="#delete<?=$idf;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr> 
                                        ...
                                        <div class="modal fade" id="edit<?=$idf;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title">Edit <?=$judul_bf;?> </h4>
                                                ...
                                                <input type="text" name="judul_bf" class="form-control" placeholder="Nama Pelanggan" value="<?=$judul_bf;?>">
                                                <input type="text" name="genre_bf" class="form-control mt-2" placeholder="Nomor Telepon" value="<?=$genre_bf;?>">
                                                <input type="text" name="penulis_bf" class="form-control mt-2" placeholder="Penulis" value="<?=$penulis_bf;?>">
                                                <input type="text" name="penerbit_bf" class="form-control mt-2" placeholder="Penerbit" value="<?=$penerbit_bf;?>">
                                                <input type="text" name="tahunterbit_bf" class="form-control mt-2" placeholder="Tahun Terbit" value="<?=$tahunterbit_bf;?>">
                                                <input type="text" name="kotaterbit_bf" class="form-control mt-2" placeholder="Kota Terbit" value="<?=$kotaterbit_bf;?>">
                                                <input type="hidden" name="idf" value="<?=$idf;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editfiksi">Submit</button>
                                        ...
                                        <div class="modal fade" id="delete<?=$idf;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$judul_bf;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusfiksi">Submit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambah Buku Bacaan Fiksi</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <input type="text" name="judul_bf" class="form-control" placeholder="Judul Buku">
          <input type="text" name="genre_bf" class="form-control mt-2" placeholder="Genre">
          <input type="text" name="penulis_bf" class="form-control mt-2" placeholder="Penulis">
          <input type="text" name="penerbit_bf" class="form-control mt-2" placeholder="Penerbit">
          <input type="num" name="tahunterbit_bf" class="form-control mt-2" placeholder="Tahun Terbit">
          <input type="text" name="kotaterbit_bf" class="form-control mt-2" placeholder="Kota Terbit">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="tambah_bf">Submit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
