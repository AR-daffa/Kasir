...
$h1 = mysqli_query($c,"select * from anime");
            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Anime Movies</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body">Jumlah Anime Movies: <?=$h2?></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from anime");
                                    $i = 1;
                            ...
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$sutradara_ma;?></td>
                                            <td><?=$produser_ma;?></td>
                                            <td><?=$rumahproduksi_ma;?></td>
                                            <td><?=$tahunrilis_ma;?></td>
                                            <td><?=$durasi_ma;?></td>
                                            <td><?=$rating_ma;?></td>
                                            <td><button type="button" class="btn btn-warning mb-4" data-toggle="modal" data-target="#edit<?=$idanime;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" data-toggle="modal" data-target="#delete<?=$idanime;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr>
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="edit<?=$idanime;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Edit <?=$judul_ma;?> </h4>
                                                ...
                                                <input type="text" name="judul_ma" class="form-control" placeholder="Judul" value="<?=$judul_ma;?>">
                                                <input type="text" name="sutradara_ma" class="form-control mt-2" placeholder="Sutradara" value="<?=$sutradara_ma;?>">
                                                <input type="text" name="produser_ma" class="form-control mt-2" placeholder="Produser" value="<?=$produser_ma;?>">
                                                <input type="text" name="rumahproduksi_ma" class="form-control mt-2" placeholder="Rumah Produksi" value="<?=$rumahproduksi_ma;?>">
                                                <input type="text" name="tahunrilis_ma" class="form-control mt-2" placeholder="Tahun Rilis" value="<?=$tahunrilis_ma;?>">
                                                <input type="text" name="durasi_ma" class="form-control mt-2" placeholder="Durasi" value="<?=$durasi_ma;?>">
                                                <input type="text" name="rating_ma" class="form-control mt-2" placeholder="Rating" value="<?=$rating_ma;?>">
                                                <input type="hidden" name="idanime" value="<?=$idanime;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editanime">Submit</button>
                                        ...
                                        <!-- Modal delete -->
                                        <div class="modal fade" id="delete<?=$idanime;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$judul_ma;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusanime">Submit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambah Anime Movies</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <input type="text" name="judul_ma" class="form-control" placeholder="Judul Film">
          <input type="text" name="sutradara_ma" class="form-control mt-2" placeholder="Sutradara">
          <input type="text" name="produser_ma" class="form-control mt-2" placeholder="Produser">
          <input type="text" name="rumahproduksi_ma" class="form-control mt-2" placeholder="Rumah Produksi">
          <input type="num" name="tahunrilis_ma" class="form-control mt-2" placeholder="Tahun Rilis">
          <input type="text" name="durasi_ma" class="form-control mt-2" placeholder="Durasi">
          <input type="text" name="rating_ma" class="form-control mt-2" placeholder="Rating">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="tambah_ma">Submit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
