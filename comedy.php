...
$h1 = mysqli_query($c,"select * from comedy");
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text text-white mx-3">Hey, Daffa !</div>
            </a>
            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Comedy Movies</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body">Jumlah Comedy Movies: <?=$h2?></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from comedy");
                                    $i = 1;
                            ...
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$sutradara_mc;?></td>
                                            <td><?=$produser_mc;?></td>
                                            <td><?=$rumahproduksi_mc;?></td>
                                            <td><?=$tahunrilis_mc;?></td>
                                            <td><?=$durasi_mc;?></td>
                                            <td><?=$rating_mc;?></td>
                                            <td><button type="button" class="btn btn-warning mb-4" data-toggle="modal" data-target="#edit<?=$idc;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" data-toggle="modal" data-target="#delete<?=$idc;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr> 
                                        ...
                                        <div class="modal fade" id="edit<?=$idc;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title">Edit <?=$judul_mc;?> </h4>
                                                ...
                                                <input type="text" name="judul_mc" class="form-control" placeholder="Judul" value="<?=$judul_mc;?>">
                                                <input type="text" name="sutradara_mc" class="form-control mt-2" placeholder="Sutradara" value="<?=$sutradara_mc;?>">
                                                <input type="text" name="produser_mc" class="form-control mt-2" placeholder="Produser" value="<?=$produser_mc;?>">
                                                <input type="text" name="rumahproduksi_mc" class="form-control mt-2" placeholder="Rumah Produksi" value="<?=$rumahproduksi_mc;?>">
                                                <input type="text" name="tahunrilis_mc" class="form-control mt-2" placeholder="Tahun Rilis" value="<?=$tahunrilis_mc;?>">
                                                <input type="text" name="durasi_mc" class="form-control mt-2" placeholder="Durasi" value="<?=$durasi_mc;?>">
                                                <input type="text" name="rating_mc" class="form-control mt-2" placeholder="Rating" value="<?=$rating_mc;?>">
                                                <input type="hidden" name="idc" value="<?=$idc;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editcomedy">Submit</button>
                                        ...
                                        <div class="modal fade" id="delete<?=$idc;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$judul_mc;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapuscomedy">Submit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambah Comedy Movies</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <input type="text" name="judul_mc" class="form-control" placeholder="Judul Film">
          <input type="text" name="sutradara_mc" class="form-control mt-2" placeholder="Sutradara">
          <input type="text" name="produser_mc" class="form-control mt-2" placeholder="Produser">
          <input type="text" name="rumahproduksi_mc" class="form-control mt-2" placeholder="Rumah Produksi">
          <input type="num" name="tahunrilis_mc" class="form-control mt-2" placeholder="Tahun Rilis">
          <input type="text" name="durasi_mc" class="form-control mt-2" placeholder="Durasi">
          <input type="text" name="rating_mc" class="form-control mt-2" placeholder="Rating">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="tambah_mc">Submit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
