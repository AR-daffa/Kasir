    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                CURRENT INCOME</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp895.000</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                TOTAL SPENDING</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp305.000</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">REQUEST ORDER
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
            ...
            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>Website ini adalah website aplikasi pemesanan barang yang dibuat untuk 
                                        memenuhi tugas tantangan Infrastruktur Teknologi Informasi dan Komunikasi.
                                        Website ini menggunakan source code html dan php dengan databasenya menggunakan php mysql.
