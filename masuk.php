            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Produk Masuk</h1>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from masuk m, produk p where m.kode_produk=p.kode_produk");
                                    $i = 1;
                            ...
                            ?>
                                        ...
                                        <tr>
                                            <td><?=$i++;?></td>
                                            <td><?=$jenis_produk;?> <?=$kategori_produk;?> : <?=$judul_produk;?></td>
                                            <td><?=$qty;?></td>
                                            <td><?=$tanggal_masuk;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning mb-4" 
                                                data-toggle="modal" data-target="#edit<?=$kode_masuk;?>">
                                                    Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" 
                                                data-toggle="modal" data-target="#delete<?=$kode_masuk;?>">
                                                    Delete
                                                </button> 
                                            </td>
                                        </tr> 
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="edit<?=$kode_masuk;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                value="<?=$jenis_produk;?> <?=$kategori_produk;?> : <?=$judul_produk;?>" disabled>
                                                <input type="number" name="qty" class="form-control mt-2" placeholder="Quantity" value="<?=$qty;?>">
                                                <input type="hidden" name="idm" value="<?=$kode_masuk;?>">
                                        ...
                                        <!-- Modal delete -->
                                        <div class="modal fade" id="delete<?=$kode_masuk;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus data barang masuk: <?=$judul_produk;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
