...
$h1 = mysqli_query($c,"select * from income");
            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Pendapatan</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-dark text-white mb-4">
                                    <div class="card-body">Current Income: Rp895.000</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from income");
                                    $i = 1;
                                    
                                    while($_POST = mysqli_fetch_array($get)){
                                        $tanggal_income = $_POST['tanggal_income'];
                                        $sumber_income = $_POST['sumber_income'];
                                        $jumlah_income = $_POST['jumlah_income'];
                                        $keterangan_income = $_POST['keterangan_income'];
                                        $idi = $_POST['kode_income'];
                            ?>

                                        <tr>
                                            <td><?=$i++;?></td>
                                            <td><?=$tanggal_income;?></td>
                                            <td><?=$sumber_income;?></td>
                                            <td>Rp<?=number_format($jumlah_income);?></td>
                                            <td><?=$keterangan_income;?></td>
                                            <td><button type="button" class="btn btn-warning mb-4" data-toggle="modal" data-target="#edit<?=$idi;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" data-toggle="modal" data-target="#delete<?=$idi;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="edit<?=$idi;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title">Edit <?=$keterangan_income;?> - <?=$sumber_income;?> : Rp<?=number_format($jumlah_income);?></h4>
                                                ...
                                                <input type="text" name="sumber_income" class="form-control" placeholder="Sumber Penghasilan" value="<?=$sumber_income;?>">
                                                <input type="text" name="jumlah_income" class="form-control mt-2" placeholder="Nominal" value="<?=$jumlah_income;?>">
                                                <input type="text" name="keterangan_income" class="form-control mt-2" placeholder="Keterangan" value="<?=$keterangan_income;?>">
                                                <input type="hidden" name="idi" value="<?=$idi;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editincome">Submit</button>
                                        ...
                                        <div class="modal fade" id="delete<?=$idi;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$keterangan_income;?> - <?=$sumber_income;?> : Rp<?=number_format($jumlah_income);?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusincome">Submit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <input type="text" name="sumber_income" class="form-control mt-2" placeholder="Nama Pelanggan">
          <input type="text" name="jumlah_income" class="form-control mt-2" placeholder="Nominal">
          <input type="text" name="keterangan_income" class="form-control mt-2" placeholder="Keterangan">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="tambah_income">Submit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
