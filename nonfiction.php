...
//hitung jumlah buku nonfiksi
$h1 = mysqli_query($c,"select * from nonfiksi");
$h2 = mysqli_num_rows($h1); //jumlah nonfiksi
?>
            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Buku Non Fiksi</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body">Jumlah Buku Nonfiksi: <?=$h2?></div>
                                </div>
                            </div>
                        </div>

                 <!-- Button to Open the Modal -->
                <button type="button" class="btn btn-success mb-4" data-toggle="modal" data-target="#myModal">
                    Tambah Buku
                </button>
                ...
                <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Data Buku Bacaan Non Fiksi
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered" id="datatablesSimple" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Judul Buku Non Fiksi</th>
                                            <th>Genre</th>
                                            <th>Penulis</th>
                                            <th>Penerbit</th>
                                            <th>Tahun Terbit</th>
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from nonfiksi");
                                    $i = 1;
                            ...
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$penulis_bnf;?></td>
                                            <td><?=$penerbit_bnf;?></td>
                                            <td><?=$tahunterbit_bnf;?></td>
                                            <td><?=$kotaterbit_bnf;?></td>
                                            <td><button type="button" class="btn btn-warning mb-2" data-toggle="modal" data-target="#edit<?=$idnf;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-2" data-toggle="modal" data-target="#delete<?=$idnf;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr> 
                                         ...
                                         <!-- Modal Edit -->
                                         <div class="modal fade" id="edit<?=$idnf;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Edit <?=$judul_bnf;?> </h4>
                                                ...
                                                <input type="text" name="judul_bnf" class="form-control" placeholder="Nama Pelanggan" value="<?=$judul_bnf;?>">
                                                <input type="text" name="genre_bnf" class="form-control mt-2" placeholder="Nomor Telepon" value="<?=$genre_bnf;?>">
                                                <input type="text" name="penulis_bnf" class="form-control mt-2" placeholder="Penulis" value="<?=$penulis_bnf;?>">
                                                <input type="text" name="penerbit_bnf" class="form-control mt-2" placeholder="Penerbit" value="<?=$penerbit_bnf;?>">
                                                <input type="text" name="tahunterbit_bnf" class="form-control mt-2" placeholder="Tahun Terbit" value="<?=$tahunterbit_bnf;?>">
                                                <input type="text" name="kotaterbit_bnf" class="form-control mt-2" placeholder="Kota Terbit" value="<?=$kotaterbit_bnf;?>">
                                                <input type="hidden" name="idnf" value="<?=$idnf;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editnonfiksi">Submit</button>
                                        ...
                                        <!-- Modal delete -->
                                        <div class="modal fade" id="delete<?=$idnf;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$judul_bnf;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusnonfiksi">Submit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambah Buku Bacaan Non Fiksi</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <input type="text" name="judul_bnf" class="form-control" placeholder="Judul Buku">
          <input type="text" name="genre_bnf" class="form-control mt-2" placeholder="Genre">
          <input type="text" name="penulis_bnf" class="form-control mt-2" placeholder="Penulis">
          <input type="text" name="penerbit_bnf" class="form-control mt-2" placeholder="Penerbit">
          <input type="num" name="tahunterbit_bnf" class="form-control mt-2" placeholder="Tahun Terbit">
          <input type="text" name="kotaterbit_bnf" class="form-control mt-2" placeholder="Kota Terbit">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="tambah_bnf">Submit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
