...
$h1 = mysqli_query($c,"select * from action");
            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Action Movies</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-3">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Jumlah Action Movies: <?=$h2?></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from action");
                                    $i = 1;
                            ...
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$sutradara_mac;?></td>
                                            <td><?=$produser_mac;?></td>
                                            <td><?=$rumahproduksi_mac;?></td>
                                            <td><?=$tahunrilis_mac;?></td>
                                            <td><?=$durasi_mac;?></td>
                                            <td><?=$rating_mac;?></td>
                                            <td><button type="button" class="btn btn-warning mb-4" data-toggle="modal" data-target="#edit<?=$idac;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" data-toggle="modal" data-target="#delete<?=$idac;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr> 
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="edit<?=$idac;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Edit <?=$judul_mac;?> </h4>
                                                ...
                                                <input type="text" name="judul_mac" class="form-control" placeholder="Judul" value="<?=$judul_mac;?>">
                                                <input type="text" name="sutradara_mac" class="form-control mt-2" placeholder="Sutradara" value="<?=$sutradara_mac;?>">
                                                <input type="text" name="produser_mac" class="form-control mt-2" placeholder="Produser" value="<?=$produser_mac;?>">
                                                <input type="text" name="rumahproduksi_mac" class="form-control mt-2" placeholder="Rumah Produksi" value="<?=$rumahproduksi_mac;?>">
                                                <input type="text" name="tahunrilis_mac" class="form-control mt-2" placeholder="Tahun Rilis" value="<?=$tahunrilis_mac;?>">
                                                <input type="text" name="durasi_mac" class="form-control mt-2" placeholder="Durasi" value="<?=$durasi_mac;?>">
                                                <input type="text" name="rating_mac" class="form-control mt-2" placeholder="Rating" value="<?=$rating_mac;?>">
                                                <input type="hidden" name="idac" value="<?=$idac;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editaction">Submit</button>
                                        ...
                                        <!-- Modal delete -->
                                        <div class="modal fade" id="delete<?=$idac;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$judul_mac;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusaction">Submit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambah Action Movies</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <input type="text" name="judul_mac" class="form-control" placeholder="Judul Film">
          <input type="text" name="sutradara_mac" class="form-control mt-2" placeholder="Sutradara">
          <input type="text" name="produser_mac" class="form-control mt-2" placeholder="Produser">
          <input type="text" name="rumahproduksi_mac" class="form-control mt-2" placeholder="Rumah Produksi">
          <input type="num" name="tahunrilis_mac" class="form-control mt-2" placeholder="Tahun Rilis">
          <input type="text" name="durasi_mac" class="form-control mt-2" placeholder="Durasi">
          <input type="text" name="rating_mac" class="form-control mt-2" placeholder="Rating">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="tambah_mac">Submit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
