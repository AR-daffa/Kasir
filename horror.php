...
$h1 = mysqli_query($c,"select * from horror");
            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Horror Movies</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Jumlah Horror Movies: <?=$h2?></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from horror");
                                    $i = 1;
                            ...
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$sutradara_mh;?></td>
                                            <td><?=$produser_mh;?></td>
                                            <td><?=$rumahproduksi_mh;?></td>
                                            <td><?=$tahunrilis_mh;?></td>
                                            <td><?=$durasi_mh;?></td>
                                            <td><?=$rating_mh;?></td>
                                            <td><button type="button" class="btn btn-warning mb-4" data-toggle="modal" data-target="#edit<?=$idh;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" data-toggle="modal" data-target="#delete<?=$idh;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="edit<?=$idh;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title">Edit <?=$judul_mh;?> </h4>
                                                ...
                                                <input type="text" name="judul_mh" class="form-control" placeholder="Judul" value="<?=$judul_mh;?>">
                                                <input type="text" name="sutradara_mh" class="form-control mt-2" placeholder="Sutradara" value="<?=$sutradara_mh;?>">
                                                <input type="text" name="produser_mh" class="form-control mt-2" placeholder="Produser" value="<?=$produser_mh;?>">
                                                <input type="text" name="rumahproduksi_mh" class="form-control mt-2" placeholder="Rumah Produksi" value="<?=$rumahproduksi_mh;?>">
                                                <input type="text" name="tahunrilis_mh" class="form-control mt-2" placeholder="Tahun Rilis" value="<?=$tahunrilis_mh;?>">
                                                <input type="text" name="durasi_mh" class="form-control mt-2" placeholder="Durasi" value="<?=$durasi_mh;?>">
                                                <input type="text" name="rating_mh" class="form-control mt-2" placeholder="Rating" value="<?=$rating_mh;?>">
                                                <input type="hidden" name="idh" value="<?=$idh;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="edithorror">Submit</button>
                                        ...
                                        <div class="modal fade" id="delete<?=$idh;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$judul_mh;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapushorror">Submit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambah Horror Movies</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <input type="text" name="judul_mh" class="form-control" placeholder="Judul Film">
          <input type="text" name="sutradara_mh" class="form-control mt-2" placeholder="Sutradara">
          <input type="text" name="produser_mh" class="form-control mt-2" placeholder="Produser">
          <input type="text" name="rumahproduksi_mh" class="form-control mt-2" placeholder="Rumah Produksi">
          <input type="num" name="tahunrilis_mh" class="form-control mt-2" placeholder="Tahun Rilis">
          <input type="text" name="durasi_mh" class="form-control mt-2" placeholder="Durasi">
          <input type="text" name="rating_mh" class="form-control mt-2" placeholder="Rating">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="tambah_mh">Submit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
