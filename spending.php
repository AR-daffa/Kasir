...
$h1 = mysqli_query($c,"select * from spending");
            ...
            <div id="content">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-dark text-white mb-4">
                                    <div class="card-body">Current Spending: <?=$h2?></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from spending");
                                    $i = 1;
                                    
                                    while($_POST = mysqli_fetch_array($get)){
                                        $tanggal_spending = $_POST['tanggal_spending'];
                                        ...
                                        $ids = $_POST['kode_spending'];
                            ?>
                                        <tr>
                                            <td><?=$i++;?></td>
                                            <td><?=$tanggal_spending;?></td>
                                            <td><?=$deskripsi_spending;?></td>
                                            <td><?=$kategori_spending;?></td>
                                            <td>Rp<?=number_format($jumlah_spending);?></td>
                                            <td><?=$metode_spending;?></td>
                                            <td><button type="button" class="btn btn-warning mb-4" data-toggle="modal" data-target="#edit<?=$ids;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" data-toggle="modal" data-target="#delete<?=$ids;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="edit<?=$ids;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title">Edit <?=$deskripsi_spending;?> - <?=$kategori_spending;?></h4>
                                                ...
                                                <input type="text" name="deskripsi_spending" class="form-control" placeholder="Deskripsi Pengeluaran" value="<?=$deskripsi_spending;?>">
                                                <input type="text" name="kategori_spending" class="form-control mt-2" placeholder="Kategori" value="<?=$kategori_spending;?>">
                                                <input type="text" name="jumlah_spending" class="form-control mt-2" placeholder="Nominal" value="<?=$jumlah_spending;?>">
                                                <input type="text" name="metode_spending" class="form-control mt-2" placeholder="Metode" value="<?=$metode_spending;?>">
                                                <input type="hidden" name="ids" value="<?=$ids;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editspending">Submit</button>
                                        ...
                                        <div class="modal fade" id="delete<?=$ids;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$deskripsi_spending;?> - <?=$kategori_spending;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusspending">Submit</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <input type="text" name="deskripsi_spending" class="form-control mt-2" placeholder="Deskripsi Pengeluaran">
          <input type="text" name="kategori_spending" class="form-control mt-2" placeholder="Kategori">
          <input type="text" name="jumlah_spending" class="form-control mt-2" placeholder="Nominal">
          <input type="text" name="metode_spending" class="form-control mt-2" placeholder="Metode">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="tambah_spending">Submit</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        </div>
