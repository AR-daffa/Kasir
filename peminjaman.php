            ...
            <div id="content">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-dark text-white mb-4">
                                    <div class="card-body">Jumlah Pemesanan: <?=$h2?></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from pesanan p, pelanggan pl where p.kode_pelanggan=pl.kode_pelanggan");
                                    ...
                                    while($_POST = mysqli_fetch_array($get)){
                                        ...
                                        //hitung jumlah
                                        $hitungjumlah = mysqli_query($c,"select * from detailpesanan where kode_pesanan= '$kode_pesanan'");
                            ...
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$nama_pelanggan;?> - <?=$asal_pelanggan;?></td>
                                            <td><?=$jumlah;?></td>
                                            <td>
                                                <a href="view.php?idp=<?=$kode_pesanan;?>" class="btn btn-info mb-4" target="blank">Tampilkan</a>
                                                <button type="button" class="btn btn-danger mb-4" data-toggle="modal" data-target="#delete<?=$kode_pesanan;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr> 
                                         ...
                                         <!-- Modal delete -->
                                         <div class="modal fade" id="delete<?=$kode_pesanan;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <input type="hidden" name="ido" value="<?=$kode_pesanan;?>">
                                                </div> 
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            while($pl=mysqli_fetch_array($getpelanggan)){
                ...
                $asal_pelanggan = $pl['asal_pelanggan'];

            ?>

            <option value="<?=$kode_pelanggan;?>"><?=$nama_pelanggan;?> - <?=$asal_pelanggan;?></option>
