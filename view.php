...
if(isset($_GET['idp'])){
    ...
    $ambilnamapelanggan = mysqli_query($c,"select * from pesanan p, pelanggan pl where p.kode_pelanggan=pl.kode_pelanggan and p.kode_pesanan='$idp'");
            ...
            <li class="nav-item">
                ...
                <div id="collapsePelanggan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="peminjaman.php">Pemesanan</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Pemesanan: <?=$idp;?></h1>
                        <h4 class="mt-4">Nama Pelanggan: <?=$namapel;?></h4>
                        <ol class="breadcrumb mb-5"></ol>
                ...
                <div class="card mb-4">
                                ...
                                <table class="table table-bordered" id="datatablesSimple" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama Produk</th>
                                            <th>Jenis dan Kategori Produk</th>
                                            <th>Harga Satuan</th>
                                            <th>Jumlah</th>
                                            <th>Sub Total</th>
                                        </tr>
                            ...
                            <?php
                                    ...
                                    $get = mysqli_query($c,"select * from detailpesanan p, produk pr where p.kode_produk=pr.kode_produk and kode_pesanan='$idp'");
                                    $i = 1;
                                    
                                    while($_POST = mysqli_fetch_array($get)){
                                        $idpr = $_POST['kode_produk'];
                                        $iddp = $_POST['kode_detailpesanan'];
                                        $qty = $_POST['qty'];
                            ...
                            ?>
                                        ...
                                        <tr>
                                            <td><?=$i++;?></td>
                                            <td><?=$judul_produk;?></td>
                                            <td><?=$jenis_produk;?> - <?=$kategori_produk;?></td>
                                            <td>Rp<?=number_format($harga_produk);?></td>
                                            <td><?=number_format($qty);?></td>
                                            <td>Rp<?=number_format($subtotal);?></td>
                                            <td><button type="button" class="btn btn-warning mb-4" data-toggle="modal" data-target="#edit<?=$idpr;?>">
                                                Edit
                                                </button> 
                                        ...
                                        <div class="modal fade" id="edit<?=$idpr;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <input type="text" name="jenis_produk" class="form-control" placeholder="Jenis Produk" value="<?=$jenis_produk;?> <?=$kategori_produk;?> : <?=$judul_produk;?>" disabled>
                                                <input type="text" name="harga_produk" class="form-control" placeholder="Harga Produk" value="Harga: Rp<?=$harga_produk;?>" disabled>
                                        ...
                                        <div class="modal fade" id="delete<?=$idpr;?>">>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="idpr" value="<?=$idpr?>">
                                                    <input type="hidden" name="kode_pesanan" value="<?=$idp?>">
                                                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php
            $getproduk = mysqli_query($c, "select * from produk where kode_produk not in
            (select kode_produk from detailpesanan where kode_pesanan='$idp')");

            while($pl=mysqli_fetch_array($getproduk)){
                $kode_produk = $pl['kode_produk'];
                $jenis_produk = $pl['jenis_produk'];
                $judul_produk = $pl['judul_produk'];
                $kategori_produk = $pl['kategori_produk'];
                $stok_produk = $pl['stok_produk'];
                $harga_produk = $pl['harga_produk'];

            ?>

            <option value="<?=$kode_produk;?>"><?=$jenis_produk;?> <?=$kategori_produk;?> - <?=$judul_produk;?>
            (Stok:) <?=$stok_produk;?>
            </option>
