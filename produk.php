            ...
            <div id="content">
                ...
                <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                id="datatablesSimple" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Jenis Produk</th>
                            ...
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                data-toggle="modal" data-target="#edit<?=$kode_produk;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" 
                                                data-toggle="modal" data-target="#delete<?=$kode_produk;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr>
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="edit<?=$kode_produk;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Ubah <?=$judul_produk;?> </h4>
                                                ...
                                                <input type="text" name="jenis_produk" class="form-control" placeholder="Jenis Produk" value="<?=$jenis_produk;?>">
                                                <input type="text" name="judul_produk" class="form-control mt-2" placeholder="Judul" value="<?=$judul_produk;?>">
                                                <input type="text" name="kategori_produk" class="form-control mt-2" placeholder="Kategori" value="<?=$kategori_produk;?>">
                                                <input type="num" name="harga_produk" class="form-control mt-2" placeholder="Harga" value="<?=$harga_produk;?>">
                                                <input type="hidden" name="idp" value="<?=$kode_produk;?>">
                                                </div>
                                        ...
                                        <!-- Modal delete -->
                                        <div class="modal fade" id="delete<?=$kode_produk;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus <?=$judul_produk;?> </h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="text" name="judul_produk" class="form-control mt-2" placeholder="Judul">
          <input type="text" name="kategori_produk" class="form-control mt-2" placeholder="Kategori">
          <input type="text" name="stok_produk" class="form-control mt-2" placeholder="Stok Barang">
          <input type="num" name="harga_produk" class="form-control mt-2" placeholder="Harga">
        </div>
