                ...
                <div class="card mb-4">
                            ...
                            <?php
                                    ...
                                    while($_POST = mysqli_fetch_array($get)){
                                        ...
                                        $idpl = $_POST['kode_pelanggan'];
                            ?>

                                        <tr>
                                            <td><?=$i++;?></td>
                                            <td><?=$nama_pelanggan;?></td>
                                            <td><?=$notelp_pelanggan;?></td>
                                            <td><?=$asal_pelanggan;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning mb-4" 
                                                data-toggle="modal" data-target="#edit<?=$idpl;?>">
                                                Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4" 
                                                data-toggle="modal" data-target="#delete<?=$idpl;?>">
                                                Delete
                                                </button> 
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="edit<?=$idpl;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h4 class="modal-title">Edit<?=$nama_pelanggan;?></h4>
                                                ...
                                                placeholder="Nama Pelanggan" value="<?=$nama_pelanggan;?>">
                                                <input type="text" name="notelp_pelanggan" class="form-control mt-2" 
                                                placeholder="Nomor Telepon" value="<?=$notelp_pelanggan;?>">
                                                <input type="text" name="asal_pelanggan" class="form-control mt-2" 
                                                placeholder="Asal" value="<?=$asal_pelanggan;?>">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="num" name="notelp_pelanggan" class="form-control mt-2" placeholder="Nomor Telepon">
          <input type="text" name="asal_pelanggan" class="form-control mt-2" placeholder="Asal">
        </div>
